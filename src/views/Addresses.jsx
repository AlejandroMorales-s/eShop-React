...
export default function Addresses() {
    ...
    return (
        <>
            ...
            <div className='w-95 max-w-[1000px] m-auto rounded border-2 border-white flex flex-col sm:grid sm:grid-cols-3 p-2 gap-2 shadow-containersShadow bg-white dark:bg-darkBg dark:border-gray-grayDark'>
