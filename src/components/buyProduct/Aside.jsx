            ...
            <div className='flex flex-col items-center p-2 gap-2 border-l-2 border-l-gray dark:border-l-gray-grayDark'>
                ...
                <div>
                    ...
                    <div className='flex justify-center items-center'>
                        ...
                        onInput={(e)=>{setBuyDetails({...buyDetails, amount: Number(e.target.value)})}} type="number" min='1' max='50' defaultValue={amount} />
                    </div>
                </div>
                <div className='border-y-2 border-y-gray py-2 w-full flex flex-col gap-2 dark:border-y-gray-grayDark'>
                    <div className='flex items-center justify-between'>
                        <p className='text-text font-medium text-bold dark:text-gray'>Product ({amount}):</p> 
                        <p className='text-text font-medium text-bold dark:text-gray'>${price * amount} MXN</p> 
                    </div>
                    <div className='flex items-center justify-between'>
                ...
                <div className='flex justify-between w-full'>
                    ...
                    <p className='text-boldText text-bold font-semibold dark:text-white'>${productPrice + shippingCost} MXN</p>
                </div>
            </div>
        </>
    )
