...
export default function AsideCart({ product, setTotal }) {
  ...
  return (
    <div className="flex flex-col items-center p-2 gap-2 border-l-2 border-l-gray dark:border-l-gray-grayDark">
      {product.map((item) => (
        <div key={item.name} className="flex gap-2 w-full items-center border-2 border-gray p-1 rounded dark:border-gray-grayDark">
          ...
          <div className="flex flex-col gap-1 w-[85%]">
            ...
            <div className="flex items-center gap-2 justify-between">
              <p className="text-text font-medium text-bold dark:text-white">
                $
                {item.price}
              </p>
      ...
      <div className="flex justify-between items-center w-full px-2">
        ...
        <p className="dark:text-gray font-semibold">
          $
          {price.toFixed(2)}
        </p>
      </div>
