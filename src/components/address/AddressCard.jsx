...
export default function AddressCard({currentAddress}) {
  ...
  return (
    <div className='border-2 gap-1 rounded flex flex-col justify-between items-center border-gray dark:border-gray-grayDark p-2 hover:shadow-containersShadow bg-white dark:bg-darkBg h-[400px] w-100 hover:border-primary dark:hover:border-primary-ligth hover:-translate-y-0.5 transition-all ease-in-out delay-50'>
        <div className='h-fit w-100 flex flex-col gap-1.5'>
            ...
            <p className='text-text dark:text-gray'><span className='font-medium text-boldText text-bold dark:text-white'>Name:</span> {currentAddress.name}</p>
            <p className='text-text dark:text-gray'><span className='font-medium text-boldText text-bold dark:text-white'>Zip code:</span> {currentAddress.postalCode}</p>
            <p className='text-text dark:text-gray'><span className='font-medium text-boldText text-bold dark:text-white'>Phone number:</span> {currentAddress.phoneNumber}</p>
            {currentAddress.instructions !== '' && 
              <p className='text-text dark:text-gray'><span className='font-medium text-boldText dark:text-white'>Instructions:</span><br/>{currentAddress.instructions}</p>
            }
        </div>
