    ...
    return (
        <>
            ...
            <div className='flex gap-1 w-95 max-w-[1000px] m-auto'>
                ...
                <div className='border-2 border-gray dark:border-gray-grayDark rounded bg-white w-100 shadow-containersShadow p-2 dark:bg-darkBg'>
                    <p className=' text-text dark:text-gray'><span className='font-semibold text-bold text-boldText dark:text-white'>
                        Phone number: </span>
                        {user.phone === undefined ? 
                            <>
                                <span onClick={addPhone} className='text-fb cursor-pointer'>Add phone</span> 
