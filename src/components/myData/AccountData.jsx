        ...
        <>
            ...
            <div className='flex gap-1 w-95 max-w-[1000px] m-auto'>
                <div className='w-100 rounded border-2 border-gray dark:border-gray-grayDark p-2 bg-white shadow-containersShadow dark:bg-darkBg'>
                    <p className='text-text dark:text-gray'><span className='font-semibold text-bold text-boldText dark:text-white'>User ID:</span> {user.id}</p>
                </div>
                <div className='w-100 rounded border-2 border-gray dark:border-gray-grayDark p-2 bg-white shadow-containersShadow dark:bg-darkBg'>
                    <p className='text-text dark:text-gray'><span className='font-semibold text-bold text-boldText dark:text-white'>Email:</span> {user.email}</p>
                </div>
            </div>
        </>
    )
