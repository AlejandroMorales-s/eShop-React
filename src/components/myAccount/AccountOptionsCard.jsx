...
export default function AccountOptionsCard({title, icon, link, desc}) {
    return (
        <Link to={link}>
            <div className='bg-white flex justify-between items-center gap-2 p-2 rounded shadow-containersShadow w-100 dark:bg-darkBg border-2 border-gray dark:border-gray-grayDark hover:-translate-y-0.5 hover:border-primary dark:hover:border-primary-ligth transition-all ease-in-out delay-50'>
